...
void Light::applyLight(RenderingShader* shader, const mat4& viewMatrix, const GLuint shaderType)
{
	LIGHT_APPLICATOR[_lightType]->applyLight(this, shader, viewMatrix, shaderType);
