	...
	FBO(width, height)
{
	...
	glRenderbufferStorageMultisample(GL_RENDERBUFFER, 8, GL_RGBA8, _size.x, _size.y);
	...
	glRenderbufferStorageMultisample(GL_RENDERBUFFER, 8, GL_DEPTH_COMPONENT, _size.x, _size.y);
	glBindRenderbuffer(GL_RENDERBUFFER, 0);
